...
export const mockStories: Story[] = [
  // 1. THE SENNA LEGEND
  {
    ...
    heroImage: '/commons/wiki/Special:FilePath/1988%20McLaren-Honda%20MP4%204%20Goodwood,%202009.JPG', 
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Ayrton%20Senna%201988%20Canada.jpg', caption: 'MP4/4, Senna 1988.', layout: 'full' },
  ...
  // 2. HUNT VS LAUDA
  {
    ...
    heroImage: '/commons/wiki/Special:FilePath/James%20Hunt%20-%20Dutch%20GP%201976.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/James%20Hunt%20-%20Dutch%20GP%201976.jpg', caption: 'Hunt in the rain, Zandvoort.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Niki%20Lauda%20-%20Ferrari%20312T2%20heads%20towards%20the%20swimming%20pool%20complex%20at%20the%201977%20Monaco%20GP.jpg', caption: 'Lauda Ferrari 312T2.', layout: 'portrait' },
  ...
  // 3. MASSA 2008
  {
    ...
    category: 'Tragedy',
    // Rain, Lights, Blur
    heroImage: '/commons/wiki/Special:FilePath/Massa%20Brazil%202008.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Massa%20Brazil%202008.jpg', caption: 'Interlagos grid in the rain.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Raikkonen%20Brazil%202008.jpg', caption: 'Ferrari cutting through spray.', layout: 'portrait' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Massa%20Brazil%202008%20Podium.jpg', caption: 'Massa on the podium, rain and light.', layout: 'full' }
    ]
  },
  ...
  // 4. SCHUMACHER ERA
  {
    ...
    category: 'Dynasty',
    // Red Car, Speed
    heroImage: '/commons/wiki/Special:FilePath/Michael%20Schumacher%202004%20F2004.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Scuderia%20Ferrari%20F2004.jpg', caption: 'Ferrari F2004 silhouette.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Michael%20Schumacher%202004%20F2004.jpg', caption: 'Schumacher era, red dominance.', layout: 'portrait' },
  ...
  // 5. SPA 2000
  {
    ...
    heroImage: '/commons/wiki/Special:FilePath/Mika%20H%C3%A4kkinen%202000%20United%20States%20Grand%20Prix.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Circuit%20de%20Spa-Francorchamps%20pit%20straight.jpg', caption: 'Häkkinen, focus through Eau Rouge.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Michael%20Schumacher%202000.jpg', caption: 'Schumacher, the constant adversary.', layout: 'portrait' }
    ]
  },
  ...
  // 6. HAMILTON 2021
  {
    ...
    heroImage: '/commons/wiki/Special:FilePath/Lewis%20Hamilton%20on%20his%20victory%20lap%20(14634946913).jpg',
    content: [
  ...
  // 7. CANADA 2011
  {
    ...
    heroImage: '/commons/wiki/Special:FilePath/2011%20Canadian%20GP%20-%20Winner.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/2011%20Canadian%20GP%20-%20Winner.jpg', caption: 'Parc Jean-Drapeau under rain.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Jenson%20Button%202011%20Canadian%20Grand%20Prix.jpg', caption: 'Button, soaked and relentless.', layout: 'portrait' }
    ]
  },
  ...
  // 8. FANGIO 1957
  {
    ...
    heroImage: '/commons/wiki/Special:FilePath/Maserati%20250F%20(Juan%20Fangio).jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Maserati%20250F%20at%20Goodwood%202010.jpg', caption: 'Maserati 250F lines and muscle.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Maserati%20250F%20(Juan%20Fangio).jpg', caption: 'Fangio and the 250F.', layout: 'portrait' },
  ...
  // 9. DIJON 1979
  {
    ...
    year: '1979',
    category: 'Combat',
    heroImage: '/commons/wiki/Special:FilePath/Dijon-Prenois_aerial.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Gilles%20Villeneuve%20Ferrari%20312T4.jpg', caption: 'Villeneuve\'s 312T4.', layout: 'landscape' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Renault%20RS10%20Arnoux.jpg', caption: 'Arnoux in the RS10.', layout: 'portrait' },
  ...
  // 10. IMOLA 1994
  {
    ...
    year: '1994',
    category: 'Tragedy',
    heroImage: '/commons/wiki/Special:FilePath/Autodromo%20Enzo%20e%20Dino%20Ferrari%20-%20Tamburello.jpg',
    content: [
      ...
      { type: 'image', src: 'https://images.unsplash.com/photo-1520975916090-31072b38f1f4?q=80&w=1200&auto=format&fit=crop', caption: 'Senna memorial, Parco delle Acque Minerali.', layout: 'portrait' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Autodromo%20Enzo%20e%20Dino%20Ferrari%20-%20Imola%20-%20Aerial%20(2007).jpg', caption: 'Imola, old flow, new scars.', layout: 'landscape' },
  ...
  // 11. BRAWN GP 2009
  {
    ...
    year: '2009',
    category: 'Miracle',
    heroImage: '/commons/wiki/Special:FilePath/Brawn%20BGP%20001%20at%20Goodwood%202016.jpg',
    content: [
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/BGP001%20-%20Jenson%20Button%20-%20Museo%20Seguros%20Bolivar.jpg', caption: 'BGP001 lines, white and neon.', layout: 'portrait' },
      ...
      { type: 'image', src: '/commons/wiki/Special:FilePath/Jenson%20Button%202009%20British%20GP%20helmet.jpg', caption: 'Button\'s 2009 motif.', layout: 'landscape' }
    ]
  }
];
